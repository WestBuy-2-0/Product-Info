...
const ProductInfoFulfillment = props => {
  return (
    <div className="product-info-fulfillment">
      ...
      <div className="product-info-fulfillment-option-two">
        <strong>Want it by Pony Express? </strong>Choose Pony-Express Delivery in checkout
        to 78701.
      </div>
      <div className="product-info-fulfillment-option-two">
      ...
      <div className="product-info-fulfillment-option-three">
        {" "}
        <strong>Store Pickup:</strong> If you're willing to make the trek to one of our outposts Order now and South Austin will have it
